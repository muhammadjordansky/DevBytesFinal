...
class DevByteFragment : Fragment() {
    ...
    //lazy. Ini mengharuskan viewModel tidak direferensikan sebelum onActivityCreated, yang kami lakukan di Fragmen ini.
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        viewModelAdapter = DevByteAdapter(VideoClick {
            ...
            // mencoba buat maksud langsung ke aplikasi YouTube
